    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, new Response(JSON.stringify(data), { headers: { "Content-Type": "application/json" } })];
        }
    });
}); });
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/text-to-image' \
